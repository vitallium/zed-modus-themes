...

{
  ...
  'Operandi Tinted': self.Operandi {
    ...
    // Accent mappings
    accent_0: self.red_cooler,
    accent_1: self.cyan,
    accent_2: self.magenta_cooler,
  ...
  'Operandi Deuteranopia': self.Operandi {
    ...
    fg_completion_match_1: self.yellow_warmer,
    fg_completion_match_2: self.cyan,
    ...
    mail_cite_3: self.yellow_faint,
    mail_part: self.blue,
    mail_recipient: self.blue,
    mail_subject: self.yellow_cooler,
    ...
    // Rainbow mappings
    rainbow_0: self.blue,
    rainbow_1: self.yellow,
    rainbow_2: self.blue_warmer,
    rainbow_3: self.yellow_cooler,
    rainbow_4: self.blue_cooler,
    rainbow_5: self.yellow_warmer,
    rainbow_6: self.blue_faint,
    rainbow_7: self.yellow_faint,
    rainbow_8: self.cyan,
